...
define( 'WP_RSS_MULTI_VERSION', 3.0000 );
...
//if (((!in_array(0, $catArray ) && in_array(intval($rssmi_cat), $catArray ))) || in_array(0, $catArray )) {  //*  not needed if sql query made
